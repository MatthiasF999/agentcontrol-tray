...
export function openPairInstallerSignIn(
  ...
  // Param is "claim_code" not "code" — the AgentControl app sign-in return URL
...
export function bridgePairState(): Promise<string> {
  return invoke<string>('bridge_pair_state');
}
